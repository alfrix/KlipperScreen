...
class KlipperScreenConfig:
        ...
        for section in config:
            ...
            if section == 'main':
                bools = (
                    ...
                    'show_heater_power', "show_scroll_steppers", "auto_open_extrude", "status_bar"
                )
                strs = (
    ...
    def _create_configurable_options(self, screen):
        ...
        self.configurable_options = [
            ...
            {"status_bar": {"section": "main", "name": _("Show Status Bar"), "type": "binary",
                            "value": "True", "callback": screen.toggle_statusbar}},
